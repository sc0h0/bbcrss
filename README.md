This repo [scrapes](https://github.com/jasoncartwright/bbcrss/blob/main/.github/workflows/rss.yml) the headlines in RSS format from BBC News every five minutes and versions the results as...
